...
export function SiteFooter() {
  ...
  return (
    <footer className="w-full border-t border-[color-mix(in_srgb,var(--border)_50%,transparent)] bg-[var(--background)] py-10 transition-colors duration-300">
      <div className="mx-auto max-w-6xl px-5 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            rel="noreferrer"
            className="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--muted)] transition-all duration-300 hover:text-[var(--accent)] hover:border-[var(--accent)] hover:translate-y-[-2px]"
            title="GitHub (nitesh1741)"
            aria-label="GitHub Primary"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <a
            ...
            rel="noreferrer"
            className="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] text-[var(--muted)] transition-all duration-300 hover:text-[var(--accent)] hover:border-[var(--accent)] hover:translate-y-[-2px]"
            title="GitHub (nitesh-147)"
            aria-label="GitHub Secondary"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
