...
function getContactIcon(label: string): ReactNode {
  ...
  if (norm.includes("email") || norm.includes("mail")) {
    return (
      <svg
        ...
        className="h-4.5 w-4.5 text-[var(--accent)] shrink-0 transition-transform duration-300 group-hover:scale-110"
      >
  ...
  if (norm.includes("github") || norm.includes("code")) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  if (norm.includes("location") || norm.includes("address") || norm.includes("map")) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <span className="mt-1 block font-bold text-[var(--foreground)] group-hover:text-[var(--accent)] transition-colors duration-200 text-sm break-all">
          {value}
        </span>
      </div>
    </a>
